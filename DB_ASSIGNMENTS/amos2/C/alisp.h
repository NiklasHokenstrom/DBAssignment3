 ...
 * $RCSfile: alisp.h,v $
 * $Revision: 1.23 $ $Date: 2014/12/29 21:12:07 $
 * $State: Exp $ $Locker:  $
 *
...
EXTERN void extfunction0(const char *,Lispfunction0);
EXTERN void extfunction1(const char *,Lispfunction1);
EXTERN void extfunction2(const char *,Lispfunction2);
EXTERN void extfunction3(const char *,Lispfunction3);
EXTERN void extfunction4(const char *,Lispfunction4);
EXTERN void extfunction5(const char *,Lispfunction5);
EXTERN void extfunctionn(const char *,Lispfunctionn);
EXTERN void extfunctionq(const char *,Lispfunctionn);
