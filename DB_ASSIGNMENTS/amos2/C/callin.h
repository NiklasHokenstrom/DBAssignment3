 ...
 * $RCSfile: callin.h,v $
 * $Revision: 1.47 $ $Date: 2014/12/29 21:12:08 $
 * $State: Exp $ $Locker:  $
 *
...
EXTERN int a_connect(a_connection c,const char *amosname,int catcherror);
EXTERN int a_connectto(a_connection c,const char *amosname,const char *host,
                       int catcherror);
...
EXTERN int a_getstringelem_basic(oidtype oid, int pos, char *str, 
                                 size_t maxlen, int catcherror);
